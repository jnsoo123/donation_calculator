...
var GivePageModal = createReactClass({
  ...
  render: function () {
    ...
    return React.createElement(
      "div",
      { className: "give-page-modal" },
      React.createElement(
        "div",
        { className: "modal fade", id: "pageDonationId--" + pageId },
        React.createElement(
          "div",
          ...
          React.createElement(
            ...
            React.createElement(
              "form",
              { action: "/page_donations/" + pageId, method: "POST" },
              React.createElement(
                "div",
      ...
      React.createElement(
        "div",
        { className: "modal fade", id: "pageDonationUpdateId--" + pageId },
        React.createElement(
          "div",
          { className: "modal-dialog", role: "document" },
          React.createElement(
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        ' highlighted row means the player did not reach the RSS quota for the week.'
      ),
      React.createElement(
        'h1',
        null,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            this.props.page_donations.map((function (pg, i) {
              return React.createElement(PageDonationRow, { key: i, update_policy: this.props.update_policy, page_donation: pg });
            }).bind(this))
          )
        )
      ),
      this.props.page_donations.map((function (pg, i) {
        return React.createElement(GivePageModal, { key: i, page_donation: pg, authenticity_token: this.props.authenticity_token });
      }).bind(this))
    );
  }
});
var PageDonationRow = createReactClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'tr',
      { className: isBelowQuota ? 'table-active' : '' },
      React.createElement(
        'td',
        null,
        this.props.page_donation.player.in_game_name
      ),
      React.createElement(
        'td',
        null,
        this.props.page_donation.count
      ),
      React.createElement(
        'td',
        null,
        this.props.page_donation.level
      ),
      React.createElement(
        'td',
        null,
...
var PlayerAddPointModal = createReactClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'modal fade', id: 'playerId--' + this.props.player.id },
      React.createElement(
        'div',
        { className: 'modal-dialog', role: 'document' },
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'Add Contribution Points to ' + this.props.player.in_game_name
            ),
            React.createElement(
              'button',
          ...
          React.createElement(
            'form',
            { action: '/contributions', method: 'POST', id: 'contributionForm--' + this.props.player.id },
            React.createElement(
              'div',
              { className: 'modal-body' },
              React.createElement(
                ...
                React.createElement(
                  'select',
                  { name: 'contribution[contribution_type]', className: 'custom-select', onChange: this.handleTypeChange, value: this.state.type },
                  React.createElement(
                    'option',
                    { value: 'adena' },
                    'Adena'
            ...
            React.createElement(
              ...
              React.createElement('input', { type: 'hidden', name: 'contribution[player_id]', value: this.props.player.id }),
              React.createElement('input', { type: 'hidden', name: 'authenticity_token', value: this.props.authenticity_token })
            )
          )
        )
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            this.props.players.map(function (player, i) {
              return React.createElement(PlayerRow, { player: player, key: i, rank: i + 1, crud_authority: crudAuthority });
            })
          )
        )
      ),
      this.props.players.map(function (player, i) {
        return React.createElement(PlayerAddPointModal, { authenticity_token: authenticityToken, player: player, key: i });
      }),
      this.props.players.map(function (player, i) {
        return React.createElement(PlayerUpdateLevel, { authenticity_token: authenticityToken, player: player, key: i });
      })
    );
  }
});
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'td',
        { style: { color: '#FFD700' } },
        isTopTen ? React.createElement('i', { className: 'fa fa-trophy' }) : ''
      ),
      React.createElement(
        'td',
      ...
      React.createElement(
        ...
        React.createElement(
          'span',
          { className: isBelowQuota ? 'text-danger' : '' },
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'form',
            { onSubmit: this.handleSubmit, action: '/players/' + player.id, method: 'POST' },
            React.createElement(
              'div',
              { className: 'modal-body' },
              React.createElement('input', { type: 'hidden', name: '_method', value: 'put' }),
